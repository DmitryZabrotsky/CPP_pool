...
unsigned int NinjaTrap::EnergyPoints = 120;
unsigned int NinjaTrap::MaxEnergyPoints = 120;
unsigned int NinjaTrap::MeleeAttackDamage = 60;
...
void NinjaTrap::meleeAttack(std::string const &target) {
	std::cout << "NINJ4-TP " << _name << " shadowattack ";
